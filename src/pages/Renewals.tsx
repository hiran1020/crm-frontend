        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input value={customerId} onChange={(e) => setCustomerId(e.target.value)} className={inputCls} placeholder="ACC-001" />
            </div>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
          ...
          <div>
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2} placeholder="Contract terms, volume commitment, pricing notes…" className="w-full rounded-md border border-border px-3 py-2 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100 resize-none" />
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Track fuel supply contract renewals and manage churn risk.
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-lg border border-border bg-white p-5 shadow-sm">
          <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Total Contract Value</p>
